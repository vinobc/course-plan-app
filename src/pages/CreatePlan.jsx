              ...
              <div className="flex justify-end space-x-4">
                ...
                <div className="mt-6 p-4 bg-gray-50 rounded-lg">
                  ...
                  <ol className="list-decimal pl-5 space-y-2 text-sm text-gray-600">
                    ...
                    <li>
                      For each one credit, 15 hours of delivery/ classes/
                      sessions will be there. In few cases, depending on
                      holidays on specific slot days, the total number of
                      classes/ sessions that you get may be less. Hence prepare
                      your course plan accordingly.
                    </li>
                    <li>
                      In case a class scheduled was not taken by you, indicate
                      so in column "Compensation Class". Also indicate how this
